...
#------------------------------------------------------------------
Instructions:
* SB = init_board("(file path).sudoku")
* solve(SB)

EECS 348
Sudoku player and board classes using AI techniques like forward
checking and backtracking with heuristics such as:
 -most constrained variable (MCV),
 -minimum remaining values (MRV),
 -least constrained varible(LCV).
#------------------------------------------------------------------
'''
